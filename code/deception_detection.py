# cited work 
# cite from https://github.com/narain280493/Deception-Detection
...
def readFile(filename,label,filetype):
    #print filename
    reviewDict = {}
    reviewList = []
    reviewLabel = []
...
def SVMClassifier(train_data, train_labels, test_data):
 ...
 # Perform classification with SVM, kernel=rbf
   ...
   # accuracy(prediction_linear)
    ...
    print "LibLinear:",prediction_liblinear
...
#     reviewLabel = []
#     reviewList = []
#     truereviewDict,truereviewList,truereviewLabel = readFile('true_reviews.txt',1)
#     #print truereviewList
#     falsereviewDict,falsereviewList,falsereviewLabel = readFile('false_reviews.txt',0)
#     testreviewDict,testreviewList,testreviewLabel = readFile('test_reviews.txt',0)
